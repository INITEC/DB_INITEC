...
<script type='text/javascript' languaje='javascript'>
	function tabla_editar_asistencia (divid){
        $(divid).submit();
    }
...
?>
			<tr class="registros_tabla" >
				...
				<td >
				    <form action="AD_asistencias_aux.php" method="POST" id="editar_asistencia_<?php echo $datos_reunion["id_reunion"]; ?>" >
					    <img title="Editar" src="../Imagenes/editar.png" width="20px"
					onClick="tabla_editar_asistencia('#editar_asistencia_<?php echo $datos_reunion["id_reunion"]; ?>' )">
					    <input type="hidden" name="boton-editar-asistencia" value="boton" >
