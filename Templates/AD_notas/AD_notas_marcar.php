...
<script type='text/javascript' languaje='javascript'>
	function cargar_cuadro_marcar_notas (){
        $parametros = {
            'boton-ver-cuadro-marcar-notas' : true,
            'id_examen' : <?php echo $id_examen_env; ?>
        };
        $.ajax({
