...
<script type='text/javascript' languaje='javascript'>
	function cargar_cuadro_cobros_integrantes (){
        $parametros = {'boton-ver-cuadro-cobros-integrantes' : true};
        $.ajax({
            ...
            success: function (datos){
                $("#cuadro_cobros").html(datos);
            }
        });
    }
    
    function cargar_tabla_pagos_integrantes (){
        $parametros = {'boton-ver-tabla-pagos-integrantes' : true};
        $.ajax({
            url: 'AD_pagos_aux.php',
            type: 'POST',
            async: true,
