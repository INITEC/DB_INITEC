...
if($id_persona) {
	...
	if($obligaciones->verificar_tarea($id_trabajo,$tarea_actual)) {
		...
		if( !empty($_POST)) {
			...
			if (isset($_POST['cambiar_clave'])){	
			...
			}elseif(isset($_POST['boton-elegir-integrante'])) {
				include_once ("AD_perfiles/cuadro.elegir.integrante.php");
                ...
                include_once ("AD_perfiles/tabla_datos_integrante_editar.php");
