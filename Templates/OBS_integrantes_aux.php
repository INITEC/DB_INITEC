...
if($id_persona) {
	...
	if($obligaciones->verificar_tarea($id_trabajo,$tarea_actual)) {
		...
		if( !empty($_POST)) {
			$acceso = 1;
			if (isset($_POST["boton-ver-datos-integrantes"])){	
				include_once ("OBS_integrantes/cuadro_datos_integrantes.php");
			} elseif(isset($_POST['boton-ver-datos-seleccionados-integrantes'])){
                include_once ("OBS_integrantes/tabla_datos_integrantes.php");
            }else {
